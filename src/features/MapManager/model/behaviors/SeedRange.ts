...
export class SeedRange extends TileBehavior {
  ...
  constructor(
    value: number = DEFAULT_SEED_RANGE_VALUE,
    inheritableScore: number = BehaviorInheritanceScore.INFINITE,
  ) {
    super();
    ...
    this.value = value;
    validateInheritanceScore(inheritableScore);
    this.inheritableScore = inheritableScore;
    Object.freeze(this);
  }
  ...
  protected withInheritanceScore(score: number): TileBehavior {
    return new SeedRange(this.value, score);
  }
}
